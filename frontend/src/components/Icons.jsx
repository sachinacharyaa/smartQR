/**
 * Centralized SVG icons for workflow tabs, expand/collapse, and quick feature shortcuts.
 */

export const WorkflowTabIcons = {
  url: (
...
/** Quick shortcuts shown after expanding “More” (same row as workflow tabs). */
export const QuickFeatureIcons = {
  facebook: (
    <svg viewBox="0 0 640 640" aria-hidden="true">
      <path
        fill="currentColor"
  ...
  location: (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M12 5c-2.2 0-4 1.5-4 3.2 0 2.5 4 8.5 4 8.5s4-6 4-8.5c0-1.7-1.8-3.2-4-3.2z" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
      <circle cx="12" cy="7.8" r="1.8" fill="currentColor" />
    </svg>
  )
};
